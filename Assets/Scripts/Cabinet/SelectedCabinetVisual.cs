...
public class SelectedCabinetVisual : MonoBehaviour
{
    ...
    private void Start() //Using start because it run after Awake function in Player script
    {
        ...
        {
            Player.LocalInstance.OnSelectedCabinetChanged += Player_OnSelectedCabinetChanged;
        }
        else
        {
    ...
    private void Player_OnSelectedCabinetChanged(object sender, Player.OnSelectedCabinetChangedEventArgs e)
    {
