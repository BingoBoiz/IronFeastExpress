...
using System;
using FlipBook;
namespace FlipBook.NewspaperEditor
{
    [CustomEditor(typeof(NewspaperFlipSystem))]
    public class NewspaperFlipSystemEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            list.onRemoveCallback = (ReorderableList l) =>
            {
                ...
                {
                    NewspaperFlipSystem book = target as NewspaperFlipSystem;
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                (target as NewspaperFlipSystem).UpdatePages();
            }
